...
public class DakaModelImpl extends ModelBase {
    ...
    public void signin(int command, NetWorkListener netWorkListener, String tenantId) {
        ...
        headers.put("Content-Type", "text/plain");
        ParamsBuilder paramsBuilder = ParamsBuilder.build().command(command);
        String bodyParams = "{\"checktype\":0,\"lng\":116.3730870922896,\"lat\":39.957986127185045,\"location\":\"" + location + "\",\"projectid\":\"8E3BFAF2A0000041AD09C5CD47A605A1\",\"turnname\":\"\",\"method\":7,\"accuracy\":21.64131736755371,\"memo\":\"\",\"picnum\":0,\"ssid\":\"" + ssid + "\",\"mac\":\"84:d9:31:06:5b:40\",\"version\":120}";
