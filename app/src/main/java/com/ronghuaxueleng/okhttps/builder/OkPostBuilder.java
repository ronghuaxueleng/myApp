package com.ronghuaxueleng.okhttps.builder;
...
import com.ronghuaxueleng.okhttps.okcallback.ResultMyCall;
...
public class OkPostBuilder {
    ...
    public void enqueue(final ResultCall resultMyCall) {
        if (resultMyCall != null) {
            ...
            mDelivery.post(resultMyCall::onBefore);
        }
    ...
    public OkPostBuilder mediaType(MediaType mediaType) {
        this.mediaType = mediaType;
        return this;
    }

    public OkPostBuilder paramType(int paramType) {
